  ...
  return knex('recipes_ingredients').del()
    .then(function () {
      ...
      return knex('recipes_ingredients').insert([
        ...
        { id: 5, quantity: 0.5, recipe_id: 3, ingredient_id: 4 },
        { id: 6, quantity: 0.25, recipe_id: 3, ingredient_id: 5 },
        { id: 7, quantity: 0.1, recipe_id: 2, ingredient_id: 6 },
        ...
        { id: 15, quantity: 0.4, recipe_id: 5, ingredient_id: 13 },
        { id: 16, quantity: 0.1, recipe_id: 5, ingredient_id: 14 },
        { id: 17, quantity: 0.175, recipe_id: 5, ingredient_id: 15 },
        ...
        { id: 21, quantity: 0.8, recipe_id: 6, ingredient_id: 17 },
        { id: 22, quantity: 0.4, recipe_id: 6, ingredient_id: 18 },
        { id: 23, quantity: 0.4, recipe_id: 6, ingredient_id: 19 },
