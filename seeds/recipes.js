  ...
  return knex('recipes').del()
    .then(function () {
      ...
      return knex('recipes').insert([
        ...
        {
          id: 6, name: 'Vegan Chilli', image: 'https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2018/07/vegan-chilli.jpg?itok=llhQ6gn2', method: JSON.stringify([
